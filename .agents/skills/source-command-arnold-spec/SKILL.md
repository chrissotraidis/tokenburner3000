---
name: "source-command-arnold-spec"
description: "Spec — decompose a spec document into Arnold's feature-based docs"
---

# source-command-arnold-spec

Use this skill when the user asks to run the migrated source command `arnold-spec`.
...
- If recommending: Pick a reasonable stack, explain why, write `docs/spec.md` with `(Codex-recommended)` provenance
