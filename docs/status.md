...
| Fighter Roster | 🟢 Implemented | Dated tiers, provenance, nullable prices, GPT-5.6 modes, legacy snapshots |
| Arena Select | 🟢 Implemented | Five rule profiles; Freestyle mandate reaches fight, record, and verdict |
...
| Vector-Arcade Visual System | 🟢 Implemented | Cabinet retained; fixed command bar, readable fight type, internal panels, and restrained cost meters |
...
- Automated verification: 🟢 18 tests across event engine, scoring, storage, programs, and provider usage normalization
